package org.woehlke.computer.kurzweil.wator.view.canvas.population;
...
import static org.woehlke.computer.kurzweil.wator.model.cell.LifeCycleStatus.*;
...
public class PopulationStatisticsElementsPanelLifeCycle extends SubTabImpl implements Serializable {
    ...
    public PopulationStatisticsElementsPanelLifeCycle(
        ...
        this.tab = tab;
        this.watorPopulationCensusContainer = watorPopulationCensusContainer;
    ...
    public void update() {
        WatorPopulationCensus population = this.watorPopulationCensusContainer.peek();
